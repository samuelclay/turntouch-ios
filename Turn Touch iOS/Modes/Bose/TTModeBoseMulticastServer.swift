//
//  TTModeBoseMulticastServer.swift
//  Turn Touch iOS
//
...
class TTModeBoseMulticastServer: NSObject, GCDAsyncUdpSocketDelegate {

    var delegate: TTModeBoseMulticastDelegate?
    ...
    func createMulticastReceiver() {
        ...
        let message = ["M-SEARCH * HTTP/1.1",
                       ...
                       "MX:2",
                       "MAN:\"ssdp:discover\"",
                       "USER-AGENT: Turn Touch iOS Bose Finder",
                       "", ""].joined(separator: "\r\n")
