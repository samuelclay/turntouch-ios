...
Actions:
    ...
    launch                - Launch the Turn Touch app
    terminate             - Terminate the Turn Touch app
...
Environment:
    ...
    IOS_BUNDLE_ID    - App bundle identifier (defaults to Turn Touch)
